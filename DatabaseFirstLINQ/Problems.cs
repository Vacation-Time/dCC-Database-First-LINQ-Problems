...
namespace DatabaseFirstLINQ
{
    class Problems
    {
        ...
        private void ProblemThree()
        {
            ...
            var product150 = _context.Products.Where(p => p.Price >= 150);

            foreach (Product product in product150)
            {
        ...
        private void ProblemTwelve()
        {
            ...
            {
                Name = "New Product",
                Description = "New Product Description Here Woohoo!",
                Price = 50
            };
        ...
        private void ProblemFourteen()
        {
            ...
            var productId = _context.Products.Where(p => p.Name == "New Product").Select(p => p.Id).SingleOrDefault();
            var userId = _context.Users.Where(u => u.Email == "david@gmail.com").Select(u => u.Id).SingleOrDefault();
        ...
        private void ProblemSixteen()
        {
            ...
            var product = _context.Products.Where(p => p.Name == "New Product").SingleOrDefault();
            product.Price = 55;
        ...
        private void BonusOne()
        {
            ...
            // Take the email and password and check if there is a person that matches that combination.
